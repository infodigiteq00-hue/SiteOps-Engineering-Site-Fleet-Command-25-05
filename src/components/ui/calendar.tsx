    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className: chevronCn, orientation, ...chevronProps }) => {
          if (orientation === "left") {
            return <ChevronLeft className={cn("size-4", chevronCn)} {...chevronProps} />;
          }
          if (orientation === "right") {
            return <ChevronRight className={cn("size-4", chevronCn)} {...chevronProps} />;
          }
          return <ChevronDown className={cn("size-4", chevronCn)} {...chevronProps} />;
        },
